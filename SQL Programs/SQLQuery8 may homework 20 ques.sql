...
select distinct salesman_id from salesman1
...
insert into salesman14 values(1975,'peace','hannes alfven','swedan','scientist')
insert into salesman14 values(1971,'economics','paul samuelson','usa','null')
...
select * from salesman14
where year=1970 and subject not in ('Physiology','Economics','physics','chemistry','peace')




write a SQL query to find the Nobel Prize winner in 'Literature' in the year
1971. Return winner.
...
where year>= 1965 and year<=1975 and 
subject='chemistry'
...
UNION (SELECT * FROM salesman14 WHERE (subject ='Peace' AND year>=1974)); 

----------------------------18-----------------------------------

select year, subject, winner, country,category from salesman14
where winner='louis neel'

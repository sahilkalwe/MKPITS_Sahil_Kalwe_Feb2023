...
CountryID int constraint s1 foreign key (CountryID) references countries(id),
StateId int constraint s2 foreign key (StateID) references states(id),
CityID int constraint s4 foreign key (CityID) references cities(id),
...
CREATE TABLE states(
  ...
  country_id int constraint c1 foreign key (country_id)references countries(id),
  PRIMARY KEY (id));
